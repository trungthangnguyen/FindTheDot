...
Shake* Shake::createWithDuration(float d, float strength )
{
    // call other construction method with twice the same strength
    return createWithDuration( d, strength, strength );
}

Shake* Shake::createWithDuration(float duration, float strength_x, float strength_y)
{
...
{
    return createWithDuration(_duration, _strength_x, _strength_y);
}
